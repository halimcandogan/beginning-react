      ...
      <div className="row">
        <div className="col-12 col-sm-8">
          <div className="card mb-3">
            <img src="img/eniyirenkblog.png" className="card-img-top" alt="..." />
            <div className="card-body">
              <h5 className="card-title fs-3 p-2">En iyi Renk Çiftleri</h5>
...
export default Enıyırenkcıftlerı;